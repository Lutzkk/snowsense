...
dots have been removed indicating it is an effective way to clean up the
snow mask from tiny small positives. However, it also removes some small
...
**Salomonson & Appel (2004)**: FSC = 1.45 \* NDSI - 0.45 - **Gascoin et
al. (2020)**: FSC = 0.5 \* tanh(2.65 \* NDSI - 1.42) + 0.5
